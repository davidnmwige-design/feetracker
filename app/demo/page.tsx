...
function TabCertificate() {
  ...
  async function download() {
    ...
    try {
      ...
      doc.text('Generated by Elimu Pay · support@feetracker.co.ke', W / 2, 282, { align: 'center' })

      doc.save(`EllimuPay_Certificate_${s.name.replace(/ /g, '_')}.pdf`)
    } catch (e) {
    ...
    <div>
      ...
      <div style={{ background: '#fff', borderRadius: '10px', border: '2px solid #e2e8f0', overflow: 'hidden', maxWidth: '480px', margin: '0 auto 20px', boxShadow: '0 6px 24px rgba(0,0,0,0.08)' }}>
        ...
        <div style={{ background: '#0a1f4e', padding: '8px 16px', textAlign: 'center' as const }}>
          <p style={{ fontSize: '10px', color: '#c8a84b', margin: 0 }}>Generated by Elimu Pay · {today}</p>
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <div style={{ background: '#fff', borderRadius: '10px', border: '2px solid #e2e8f0', overflow: 'hidden', maxWidth: '480px', margin: '0 auto 20px', boxShadow: '0 4px 16px rgba(0,0,0,0.06)' }}>
        ...
        <div style={{ background: '#0a1f4e', padding: '8px 16px', textAlign: 'center' as const }}>
          <p style={{ fontSize: '10px', color: '#94a3c8', margin: 0 }}>For queries contact {SCHOOL.name} · Powered by Elimu Pay</p>
        </div>
      </div>
      ...
      <div style={{ background: '#0a1f4e', padding: '16px 32px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' as const, gap: '10px' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '3px' }}>
            <span style={{ fontSize: '17px', fontWeight: 700, fontFamily: 'Georgia, serif' }}>
