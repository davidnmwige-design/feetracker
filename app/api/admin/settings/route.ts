  ...
  try {
    ...
    const settings = await prisma.platformSettings.upsert({
      ...
      update: {
        ...
        kraPin: typeof body.kraPin === 'string' ? body.kraPin : undefined,
        startingInvoiceNumber: typeof body.startingInvoiceNumber === 'number' ? body.startingInvoiceNumber : undefined,
        invoiceDueDays: typeof body.invoiceDueDays === 'number' ? body.invoiceDueDays : undefined,
        lateInterestRate: typeof body.lateInterestRate === 'number' ? body.lateInterestRate : undefined,
        emailSignature: typeof body.emailSignature === 'string' ? body.emailSignature : undefined,
      },
      create: { id: 1, ...body },
    })
    return NextResponse.json(settings)
