...
function SubmitForm() {
  ...
  if (!schoolId || !token) return (
    <div style={{ textAlign: 'center', padding: '48px', color: 'var(--ep-text-secondary)' }}>Invalid link. Please use the link from your email.</div>
  )

  return (
    <div style={{ background: 'var(--ep-bg-secondary)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 16px', fontFamily: 'Arial, sans-serif' }}>
      <div style={{ background: 'var(--ep-card-bg)', borderRadius: '10px', border: '1px solid var(--ep-border)', width: '100%', maxWidth: '500px', overflow: 'hidden' }}>
        ...
        {done ? (
          <div style={{ padding: '40px 32px', textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--ep-text-secondary)', fontSize: '14px' }}>Your testimonial has been submitted. We really appreciate your feedback.</p>
          </div>
        ) : (
          <div style={{ padding: '32px' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              <div>
                <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--ep-text-primary)', display: 'block', marginBottom: '6px' }}>Your name *</label>
              ...
              <div>
                <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--ep-text-primary)', display: 'block', marginBottom: '6px' }}>Your title (optional)</label>
                <input value={form.authorTitle} onChange={e => setForm(f => ({ ...f, authorTitle: e.target.value }))}
                  placeholder="e.g. Bursar, Principal"
                  style={{ width: '100%', border: '1px solid var(--ep-border)', borderRadius: '6px', padding: '8px 12px', fontSize: '13px', outline: 'none', boxSizing: 'border-box' }} />
              </div>
              <div>
                <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--ep-text-primary)', display: 'block', marginBottom: '8px' }}>Your rating *</label>
              ...
              <div>
                <label style={{ fontSize: '12px', fontWeight: 600, color: 'var(--ep-text-primary)', display: 'block', marginBottom: '6px' }}>Your experience * <span style={{ fontWeight: 400, color: 'var(--ep-text-tertiary)' }}>(min 20 chars)</span></label>
                <textarea value={form.quote} onChange={e => setForm(f => ({ ...f, quote: e.target.value }))}
                  ...
                  rows={4}
                  style={{ width: '100%', border: '1px solid var(--ep-border)', borderRadius: '6px', padding: '8px 12px', fontSize: '13px', outline: 'none', resize: 'vertical', boxSizing: 'border-box' }} />
