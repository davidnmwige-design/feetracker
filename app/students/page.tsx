...
async function downloadCertificate(studentId: number, studentName: string) {
  ...
  doc.text('Fee Clearance Certificate', 105, 30, { align: 'center' })
  
  doc.setFontSize(12)
  doc.setTextColor(0, 0, 0)
  doc.text(data.school.name, 105, 45, { align: 'center' })
  doc.text(data.school.term, 105, 55, { align: 'center' })
  ...
  doc.text(data.student.name, 80, 80)
  
  doc.setFont('helvetica', 'normal')
  doc.text('Admission No:', 20, 95)
  doc.setFont('helvetica', 'bold')
  doc.text(data.student.admNo, 80, 95)
  
  doc.setFont('helvetica', 'normal')
  doc.text('Class:', 20, 110)
  doc.setFont('helvetica', 'bold')
  doc.text(data.student.class + ' ' + data.student.stream, 80, 110)
  
  doc.setFont('helvetica', 'normal')
  doc.text('Fee Required:', 20, 125)
  doc.setFont('helvetica', 'bold')
  doc.text('KES ' + data.student.feeRequired.toLocaleString(), 80, 125)
  
  doc.setFont('helvetica', 'normal')
  doc.text('Total Paid:', 20, 140)
  doc.setFont('helvetica', 'bold')
  doc.text('KES ' + data.student.totalPaid.toLocaleString(), 80, 140)
  
  doc.setFont('helvetica', 'normal')
  doc.text('Balance:', 20, 155)
  doc.setFont('helvetica', 'bold')
  doc.text('KES 0', 80, 155)
  ...
  doc.setTextColor(15, 110, 86)
  doc.setFont('helvetica', 'bold')
  doc.text('This student has been cleared for ' + data.school.term, 105, 185, { align: 'center' })
  
  doc.setFontSize(10)
  doc.setTextColor(150, 150, 150)
  doc.setFont('helvetica', 'normal')
  doc.text('Generated by FeeTracker · ' + new Date().toLocaleDateString(), 105, 200, { align: 'center' })
  
  doc.save(studentName + '_clearance.pdf')
}
  useEffect(() => {
    fetchStudents()
  }, [])
