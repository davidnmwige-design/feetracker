...
export default function Reports() {
  ...
  async function printReport() {
    ...
    try {
      ...
      // Summary stats — 2x2 grid, centered
      ...
      // "Generated by Elimu Pay" at bottom of cover
      doc.setFont('helvetica', 'normal'); doc.setFontSize(9); doc.setTextColor(148, 163, 184)
      doc.text('Generated by Elimu Pay', PW / 2, 270, { align: 'center' })
      ...
      for (let p = 1; p <= totalPages; p++) {
        ...
        doc.text('Generated by Elimu Pay', PW - 12, 290, { align: 'right' })
      }
